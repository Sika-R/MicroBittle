...
// v2.9 - new block
public class BE2_Ins_RemoveIndexFromList : BE2_InstructionBase, I_BE2_Instruction
{
    ...
    public new void Function()
    {
        ...
        {
            _variablesManager.RemoveListItem(Section0Inputs[1].StringValue, (int)Section0Inputs[0].FloatValue);
        }
