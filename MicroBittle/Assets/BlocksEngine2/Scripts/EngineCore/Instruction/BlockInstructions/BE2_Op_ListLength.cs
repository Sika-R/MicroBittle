...
// v2.9 - new block
public class BE2_Op_ListLength : BE2_InstructionBase, I_BE2_Instruction
{
    Dropdown _dropdown;
    string _lastValue;
    ...
    {
        return _variablesManager.GetListStringValues(Section0Inputs[0].StringValue).Count.ToString();
    }
}
