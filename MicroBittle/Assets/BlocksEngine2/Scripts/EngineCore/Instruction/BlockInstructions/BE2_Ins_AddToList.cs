...
// v2.9 - new block
public class BE2_Ins_AddToList : BE2_InstructionBase, I_BE2_Instruction
{
    ...
    {
        _variablesManager.AddValueInList(Section0Inputs[1].StringValue, Section0Inputs[0].StringValue);
