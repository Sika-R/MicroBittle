...
// v2.9 - new block
public class BE2_Op_ValueAtIndexAtList : BE2_InstructionBase, I_BE2_Instruction
{
    Dropdown _dropdown;
    string _lastValue;
    ...
    public new string Operation()
    {
        if (!Section0Inputs[0].InputValues.isText)
            return _variablesManager.GetListStringValue(Section0Inputs[1].StringValue, (int)Section0Inputs[0].FloatValue);
        else
            return "";
    }
}
