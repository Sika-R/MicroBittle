...
Shader "Universal Render Pipeline/Screen Space Decal/Unlit"
{
    Properties
    {
        ...
        [Enum(UnityEngine.Rendering.CompareFunction)]_StencilComp("_StencilRef value", Float) = 0 //0 = disable

        [Header(ZTest)]
        [Enum(UnityEngine.Rendering.CompareFunction)]_ZTest("_ZTest  _____to improve GPU performance", Float) = 0 //0 = disable
        ...
        [Toggle(_SupportOrthographicCamera)] _SupportOrthographicCamera("_SupportOrthographicCamera", Float) = 0
    }
